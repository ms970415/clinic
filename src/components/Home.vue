  ...
  <el-container class="home-container">
    ...
    <el-container>
      ...
      <el-aside :width="isCollapse ? '64px' : '200px' ">
        ...
        -->
        <el-menu background-color="#cbfffc" text-color="#000000" active-text-color="#4094ff" unique-opened
...
<script>
  export default {
    ...
    data() {
      return {
        ...
        menuIcon: {
          ...
          '3': 'iconfont iconquanxian',
          '4': 'iconfont iconuser',
          '5': 'iconfont iconziyuan',
          '6': 'iconfont iconicon--copy'
        },
        //定义是否折叠
        isCollapse: false,
        //是否展现折叠动态效果
    ...
    methods: {
      ...
      async getMenuList() {
       const {data: result} =  await this.$http.get('/lists/getMenuList')
